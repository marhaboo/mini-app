...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full  px-3 pt-3 sm:px-5 sm:pt-5 transition-colors">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-3 rounded-2xl bg-white dark:bg-zinc-900 px-4 text-zinc-900 dark:text-zinc-50 shadow-md dark:shadow-zinc-950/50 sm:gap-6 sm:px-7 border border-zinc-100 dark:border-zinc-800/50">
        <Link
          href="/"
